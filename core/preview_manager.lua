-- preview_manager.lua (was viewerCore.lua)
-- Preview rendering scheduling, throttling, and management
-- Dependencies: Loaded via AseVoxel.render and AseVoxel.math namespaces
